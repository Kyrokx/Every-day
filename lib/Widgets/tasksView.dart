...
class TasksView extends StatefulWidget {
  ...
  TasksView({required this.title,required this.description, required this.hour, required this.taskUid});
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            CustomText("Date created : ${widget.hour.toDate().toString()}",fontSize: 30.0,),
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: [
                Container(
